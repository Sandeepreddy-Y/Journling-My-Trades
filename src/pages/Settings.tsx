...
import { Settings as SettingsIcon, Sun, Moon, Download, FileText, User, Keyboard } from 'lucide-react';
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-bg-card/50 backdrop-blur-lg border border-white/[0.06] rounded-2xl p-6 shadow-xl">
        <div>
          ...
          <p className="text-xs text-text-secondary mt-0.5">
            Manage your profile, theme mode, export trade data, and view keyboard shortcuts.
          </p>
        </div>
      </div>
